...
---|---
<p align="center">Server running - player control left side and received client position via socket</p> | <p align="center">Client running - player control right side and received server position via socket</p>
