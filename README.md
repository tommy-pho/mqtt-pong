...
*Server running - player control left side and received client position via socket*     | *Client running - player control right side and received server position via socket*     
------------|-------------
